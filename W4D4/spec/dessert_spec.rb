...
describe Dessert do
  ...
  subject(:dessert) { Dessert.new("delicious", 100, chef )}
  
  describe "#initialize" do
    it "sets a type" do
      expect(dessert.type).to eq("delicious")
    end
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect do
        Dessert.new("ppp", "ALL OF THEM", chef)
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
     expect { dessert.eat(200) }.to raise_error
